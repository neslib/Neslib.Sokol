...
set ARGS=/sdl- /Ox /D_CRT_SECURE_NO_WARNINGS /DCIMGUI_API=__declspec(dllexport) /wd4100 /wd4244 /wd4706 /wd4305 /wd4127 /W4 /WX /MT /GL /LD /arch:SSE2 /Isokol /Fe"sokol.dll" /DEF sokol.def sokol.c sokol/deps/cimgui.cpp sokol/deps/cimgui_internal.cpp sokol/deps/imgui.cpp sokol/deps/imgui_widgets.cpp sokol/deps/imgui_draw.cpp sokol/deps/imgui_tables.cpp sokol/deps/imgui_demo.cpp sokol/libs/basisu/sokol_basisu.cpp sokol/spine/src/*.c

cl /DNDEBUG  %ARGS%
copy /Y sokol.dll "../Samples/Bin/sokol32.dll"
del *.obj
del sokol.exp
del sokol.lib
del sokol.dll
...
cl %ARGS%
copy /Y sokol.dll "../Samples/Bin/sokold32.dll"
del *.obj
del sokol.exp
del sokol.lib
del sokol.dll