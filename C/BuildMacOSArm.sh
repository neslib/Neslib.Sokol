...
clang -c -fPIC -O3 -arch arm64 -isysroot $SDK_ROOT -DNDEBUG -Isokol -Wno-address-of-temporary -xobjective-c++ -std=c++11 -mmacosx-version-min=10.13 sokol.c sokol/deps/cimgui.cpp sokol/deps/imgui/imgui.cpp sokol/deps/imgui/imgui_widgets.cpp sokol/deps/imgui/imgui_draw.cpp sokol/deps/imgui/imgui_tables.cpp sokol/deps/imgui/imgui_demo.cpp sokol/libs/basisu/sokol_basisu.cpp
