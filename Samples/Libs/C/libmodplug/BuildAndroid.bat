...
set LIB32=obj\local\armeabi-v7a\libmodplug.a
set LIB64=obj\local\arm64-v8a\libmodplug.a
...
copy %LIB32% ..\..\libmodplug_android32.a
if %ERRORLEVEL% NEQ 0 (
...
REM Copy static library to directory with Delphi source code
copy %LIB64% ..\..\libmodplug_android64.a
if %ERRORLEVEL% NEQ 0 (
  echo Cannot copy static library. Make sure it is not write protected
)
