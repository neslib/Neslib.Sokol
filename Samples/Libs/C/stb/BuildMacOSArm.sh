...
rm libstb_macos_arm.a

clang -c -fPIC -O3 -arch arm64 -isysroot $SDK_ROOT -DNDEBUG -Wno-address-of-temporary -xobjective-c++ -std=c++11 -mmacosx-version-min=10.13 stb.c

ar rcs libstb_macos_arm.a *.o
ranlib libstb_macos_arm.a
rm *.o
