...
clang -c -O3 -arch arm64 -isysroot $SDK_ROOT -DNDEBUG -xobjective-c++ -std=c++11 -miphoneos-version-min=11.0 pl_mpeg.c

ar rcs libpl_mpeg_ios.a *.o
ranlib libpl_mpeg_ios.a
rm *.o
