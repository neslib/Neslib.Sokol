...
{ #version:1# (machine generated, don't edit!)
  ...
  Cmdline: sokol-shdc --input QuadShader.glsl --output QuadShader.pas
...
begin
  ...
  case TGfx.Backend of
    ...
    TBackend.GLCore33:
      begin
        GQuadShaderDesc.VS.Source := VS_SOURCE_GLSL330;
        GQuadShaderDesc.FS.Source := FS_SOURCE_GLSL330;
      end;
    {$ENDIF}
    ...
    TBackend.Gles2:
      begin
        GQuadShaderDesc.VS.Source := VS_SOURCE_GLSL100;
        GQuadShaderDesc.FS.Source := FS_SOURCE_GLSL100;
      end;
    {$ENDIF}
    ...
    TBackend.Gles3:
      begin
        GQuadShaderDesc.VS.Source := VS_SOURCE_GLSL300ES;
        GQuadShaderDesc.FS.Source := FS_SOURCE_GLSL300ES;
      end;
    {$ENDIF}
    ...
    TBackend.D3D11:
      begin
        GQuadShaderDesc.VS.Source := VS_SOURCE_HLSL5;
        GQuadShaderDesc.FS.Source := FS_SOURCE_HLSL5;
      end;
    {$ENDIF}
    ...
    TBackend.MetalMacOS:
      begin
        GQuadShaderDesc.VS.Source := VS_SOURCE_METAL_MACOS;
        GQuadShaderDesc.FS.Source := FS_SOURCE_METAL_MACOS;
      end;
    {$ENDIF}
    ...
    TBackend.MetalIOS:
      begin
        GQuadShaderDesc.VS.Source := VS_SOURCE_METAL_IOS;
        GQuadShaderDesc.FS.Source := FS_SOURCE_METAL_IOS;
      end;
    {$ENDIF}
  else
    Assert(False)
