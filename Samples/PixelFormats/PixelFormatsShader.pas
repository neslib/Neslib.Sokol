...
{ #version:1# (machine generated, don't edit!)
  ...
  Cmdline: sokol-shdc --input PixelFormatsShader.glsl --output PixelFormatsShader.pas
  ...
  Overview:
    ...
    Shader program 'cube':
      ...
      Vertex shader: vs_cube
        Attribute slots:
          ATTR_VS_CUBE_POS = 0
          ATTR_VS_CUBE_COLOR0 = 1
        Uniform block 'cube_vs_params':
          Delphi record: TCubeVsParams
  ...
  Vertex attribute locations for vertex shader 'vs_cube':
    ...
    PipDesc.Init;
    PipDesc.Attrs[ATTR_VS_CUBE_POS]. ...
    PipDesc.Attrs[ATTR_VS_CUBE_COLOR0]. ...
    PipDesc. ...
  ...
  Bind slot and Delphi record for uniform block 'CubeVsParams':

    CubeVsParams: TCubeVsParams;
    CubeVsParams.Mvp := ...;
    TGfx.ApplyUniforms(TShaderStage.[VertexShader|FragmentShader], SLOT_CUBE_VS_PARAMS, TRange.Create(CubeVsParams));
...
const
  VS_CUBE_SOURCE_GLSL330 =
    '#version 330'#10+

    'uniform vec4 cube_vs_params[4];'#10+
    ...
    'void main()'#10+
    '{'#10+
    '    gl_Position = mat4(cube_vs_params[0], cube_vs_params[1], cube_vs_params[2], cube_vs_params[3]) * pos;'#10+
    '    color = color0;'#10+
    '}';
...
const
  FS_BG_SOURCE_GLSL330 =
    ...
    'void main()'#10+
    '{'#10+
    '    vec2 _30 = fract((gl_FragCoord.xy - vec2(bg_fs_params[0].x)) * vec2(0.100000001490116119384765625));'#10+
...
const
  FS_BG_SOURCE_GLSL100 =
    ...
    'void main()'#10+
    '{'#10+
    '    highp vec2 _30 = fract((gl_FragCoord.xy - vec2(bg_fs_params[0].x)) * vec2(0.100000001490116119384765625));'#10+
...
{$IFDEF SOKOL_D3D11}
const
  VS_CUBE_SOURCE_HLSL5 =
    'cbuffer cube_vs_params : register(b0)'#10+
    '{'#10+
...
const
  FS_BG_SOURCE_HLSL5 =
    ...
    'void frag_main()'#10+
    '{'#10+
    '    float2 _30 = frac((gl_FragCoord.xy - _19_tick.xx) * 0.100000001490116119384765625f.xx);'#10+
    '    float _41 = _30.x * _30.y;'#10+
...
const
  VS_CUBE_SOURCE_METAL_MACOS =
    ...
    'vertex main0_out main0(main0_in in [[stage_in]], constant cube_vs_params& _21 [[buffer(0)]])'#10+
    '{'#10+
    '    main0_out out = {};'#10+
...
const
  FS_BG_SOURCE_METAL_MACOS =
    ...
    '{'#10+
    '    main0_out out = {};'#10+
    '    float2 _30 = fract((gl_FragCoord.xy - float2(_19.tick)) * float2(0.100000001490116119384765625));'#10+
    '    float _41 = _30.x * _30.y;'#10+
...
begin
  ...
  case TGfx.Backend of
    ...
    TBackend.GLCore33:
      begin
        GCubeShaderDesc.VS.Source := VS_CUBE_SOURCE_GLSL330;
    ...
    TBackend.Gles2:
      begin
        GCubeShaderDesc.VS.Source := VS_CUBE_SOURCE_GLSL100;
    ...
    TBackend.Gles3:
      begin
        GCubeShaderDesc.VS.Source := VS_CUBE_SOURCE_GLSL300ES;
    ...
    TBackend.D3D11:
      begin
        GCubeShaderDesc.VS.Source := VS_CUBE_SOURCE_HLSL5;
    ...
    TBackend.MetalMacOS:
      begin
        GCubeShaderDesc.VS.Source := VS_CUBE_SOURCE_METAL_MACOS;
    ...
    TBackend.MetalIOS:
      begin
        GCubeShaderDesc.VS.Source := VS_CUBE_SOURCE_METAL_IOS;
  ...
  if (TGfx.Backend.IsGL) then
    GCubeShaderDesc.vs.uniform_blocks[0].uniforms[0].Init('cube_vs_params', _SG_UNIFORMTYPE_FLOAT4, 4);
