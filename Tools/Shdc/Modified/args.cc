...
static void validate(args_t& args) {
    ...
    if (args.slang == 0) {
        args.slang = slang_t::bit(slang_t::GLSL100)
            | slang_t::bit(slang_t::GLSL330)
            | slang_t::bit(slang_t::GLSL100)
            | slang_t::bit(slang_t::GLSL300ES)
            | slang_t::bit(slang_t::HLSL5)
            | slang_t::bit(slang_t::METAL_MACOS)
            | slang_t::bit(slang_t::METAL_IOS);
